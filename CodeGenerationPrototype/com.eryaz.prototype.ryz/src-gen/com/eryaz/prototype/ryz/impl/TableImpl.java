 ...
 * </p>
 * <ul>
 *   <li>{@link com.eryaz.prototype.ryz.impl.TableImpl#getHeader <em>Header</em>}</li>
 * </ul>
 *
 * @generated
 */
public class TableImpl extends PresentationElementImpl implements Table {
	/**
	...
	protected EClass eStaticClass() {
		return RyzPackage.Literals.TABLE;
	}
	...
	public EList<Header> getHeader() {
		if (header == null) {
			header = new EObjectContainmentEList<Header>(Header.class, this, RyzPackage.TABLE__HEADER);
		}
		return header;
	}
