...
/**
 * This is the item provider adapter for a {@link com.eryaz.prototype.ryz.Project} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ProjectItemProvider extends NamedElementItemProvider {
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(RyzPackage.Literals.PROJECT__PACKAGES);
		}
	...
	public void notifyChanged(Notification notification) {
		...
		case RyzPackage.PROJECT__PACKAGES:
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add(
				createChildParameter(RyzPackage.Literals.PROJECT__PACKAGES, RyzFactory.eINSTANCE.createMvcPackage()));

		newChildDescriptors.add(
				createChildParameter(RyzPackage.Literals.PROJECT__PACKAGES, RyzFactory.eINSTANCE.createModelPackage()));

		newChildDescriptors.add(
				createChildParameter(RyzPackage.Literals.PROJECT__PACKAGES, RyzFactory.eINSTANCE.createViewPackage()));
