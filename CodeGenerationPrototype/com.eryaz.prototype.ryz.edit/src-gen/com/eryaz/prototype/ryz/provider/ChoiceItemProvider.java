...
/**
 * This is the item provider adapter for a {@link com.eryaz.prototype.ryz.Choice} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ChoiceItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider,
	...
	protected void addTextPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Choice_text_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Choice_text_feature", "_UI_Choice_type"),
						RyzPackage.Literals.CHOÝCE__TEXT, true, false, false,
	...
	protected void addValuePropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						RyzPackage.Literals.CHOÝCE__VALUE, true, false, false,
						ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
	}
	...
	protected void addSelectedPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Choice_selected_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Choice_selected_feature",
								"_UI_Choice_type"),
						RyzPackage.Literals.CHOÝCE__SELECTED, true, false, false,
	...
	public void notifyChanged(Notification notification) {
		...
		case RyzPackage.CHOÝCE__TEXT:
		case RyzPackage.CHOÝCE__VALUE:
		case RyzPackage.CHOÝCE__SELECTED:
