...
/**
 * This is the item provider adapter for a {@link com.eryaz.prototype.ryz.ViewPackage} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ViewPackageItemProvider extends ComponentPackageItemProvider {
	/**
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(RyzPackage.Literals.VÝEW_PACKAGE__VÝEWS);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add(
				createChildParameter(RyzPackage.Literals.VÝEW_PACKAGE__VÝEWS, RyzFactory.eINSTANCE.createPartial()));

		newChildDescriptors.add(
				createChildParameter(RyzPackage.Literals.VÝEW_PACKAGE__VÝEWS, RyzFactory.eINSTANCE.createLayout()));

		newChildDescriptors
				.add(createChildParameter(RyzPackage.Literals.VÝEW_PACKAGE__VÝEWS, RyzFactory.eINSTANCE.createView()));
	}
