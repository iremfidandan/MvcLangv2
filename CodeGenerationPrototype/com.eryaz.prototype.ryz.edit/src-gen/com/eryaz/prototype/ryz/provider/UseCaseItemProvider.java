		...
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						getString("_UI_PropertyDescriptor_description", "_UI_UseCase_helperforsendingrequest_feature",
								"_UI_UseCase_type"),
						RyzPackage.Literals.USE_CASE__HELPERFORSENDÝNGREQUEST, true, false, true, null, null, null));
	}
		...
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						getString("_UI_PropertyDescriptor_description", "_UI_UseCase_actionmethod_feature",
								"_UI_UseCase_type"),
						RyzPackage.Literals.USE_CASE__ACTÝONMETHOD, true, false, true, null, null, null));
	}
